...
BOSCHCOM_ENDPOINT_HC_CURRENT_ROOM_SETPOINT: Final[str] = "/currentRoomSetpoint" # Setback temperature
BOSCHCOM_ENDPOINT_HC_ROOM_SETPOINT: Final[str] = "/currentSetpoint"
BOSCHCOM_ENDPOINT_HC_MANUAL_ROOM_SETPOINT: Final[str] = "/manualRoomSetpoint"
BOSCHCOM_ENDPOINT_HC_MANUAL_SETPOINT: Final[str] = "/manualsetpoint"
BOSCHCOM_ENDPOINT_HC_ROOM_TEMP_SETPOINT: Final[str] = "/cooling/roomTempSetpoint"
